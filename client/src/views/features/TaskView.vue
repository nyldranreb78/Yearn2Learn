<template>
      ...
      <div class="col-8">
        <div class="row">
          ...
          <div class="col-9 pe-3">
            ...
            <div v-show="!taskList.length" class="row">
              <div class="col text-center m-4">
                <i class="text-muted"
                  >There are no tasks to show. Click on the "New Task" button to
                  add one.</i
                >
              </div>
            </div>

            <div v-for="task in taskList" :key="task?._id" class="row">
              <button
                type="button"
          ...
          <div class="col-3 bg-transparent">
            ...
            <div class="card">
              ...
              >
                <div class="row">
                  <div class="col text-start mt-1">Task Details</div>

                  <div v-show="currentTask" class="col-auto text-end">
                    <button
                      type="button"
              ...
              <div class="card-body">
                <div v-if="!currentTask" class="text-muted text-center">
                ...
                <div v-else>
                  ...
                  <div v-if="currentTask.taskGrade > 0">
                    ...
                    ><br />{{ currentTask.taskGrade }}%
                  </div>
                  <div v-if="currentTask.actualGrade > 0">
                    <b><small>Score Received:</small></b
                    ><br />{{
            ...
            <div class="card mt-3">
              ...
              >
                <div class="row">
                  <div class="col text-start mt-1">Class Progress</div>
                </div>
              </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    Select Class
                    <select v-model="currentClass" class="form-select">
                ...
                >
                  <small class="text-muted"
                    ><i
                      >You currently have no graded tasks to track for this
                ...
                <div v-if="classTasks.ungraded.length" class="mt-4">
                  ...
                  >
                    ...
                    <div class="col-6">? / {{ task.taskGrade }}</div>
                  </div>
                </div>

                <div v-if="classTasks.graded.length" class="mt-4">
                  <div class="row border-bottom pb-0 mb-2">
                    <div class="col">Graded Tasks</div>
                  </div>
  ...
  <div id="add_edit_task_form" class="modal fade" tabindex="-1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body text-start">
          ...
          >
            ...
            <div v-show="isForClass" class="col-12">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header px-2 py-1">
          <div class="modal-title fs-6">Confirm Task Deletion</div>
        ...
        <div class="modal-body">
          <h6 class="text-center">
            ...
            <br /><br /><i
              >Warning: Deleting this will remove it from your Class Progress.
            </i>
            <span v-if="!currentTask.isFinished">
              <i
                >Consider marking it as "<span class="text-success"
                  ><b>Finished</b></span
                >" instead.</i
              >
            </span>
